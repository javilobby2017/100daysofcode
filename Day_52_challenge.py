...
def viewPizza(): #subroutine for pizza toppings order name, siz,qty, and total
    h1 = "Name"
    h2 = "Topping"
    h3 = "Size"
    h4 = "Quantity"
...
def addPizza(): #subroutine for adding pizza order
    time.sleep(1)
    os.system("clear")
    name = input("Name: ")
...
while True: 
    ...
    f = open("pizza.txt", "w")
    f.write(str(pizza))
    f.close() #unable to view contents in pizza.txt file